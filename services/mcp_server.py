...
from mcp_interface import MCPMeshAdapter, MCPMeshServer
...
class CrankMCPServer:
    ...
    async def _register_services(self):
        ...
        service_configs = [
            ...
            },
            {
                ...
                "capabilities": ["parse_mbox", "classify_ai", "extract_receipts", "analyze_patterns"]
            }
        ]
    ...
    async def _simulate_agent_interaction(self):
        ...
        # Handle the request
        response = await self.adapter.handle_mcp_message(init_message)
        ...
        tools_response = await self.adapter.handle_mcp_message(list_message)

...
class MCPMeshServer:
    ...
    def _create_capability_handler(self, service: MeshInterface, capability: MeshCapability) -> Callable:
...
class MCPMeshAdapter:
    ...
    async def handle_mcp_message(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return self._error_response(request_id, f"Error handling {method}: {str(e)}")

        ...
        self.available_tools = [
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "target_format": {
                            "type": "string",
                            "description": "Target format (pdf, docx, etc.)",
                        },
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "privacy_mode": {
                            "type": "string",
                            "description": "Privacy level (strict, normal, minimal)",
                        },
                        "auth_token": {"type": "string", "description": "Authentication token"},
                    },
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "emails": {
                            "type": "array",
                            "description": "List of email content to classify",
                        },

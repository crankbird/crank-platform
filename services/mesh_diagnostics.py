...
from mesh_interface import MeshInterface, MeshRequest, MeshResponse, MeshCapability
...
class MeshDiagnostics:
    ...
    async def handle_error_test(request: MeshRequest) -> Dict[str, Any]:
        ...
        if error_type == "validation":
            ...
            huge_data = bytearray(1024 * 1024 * 1024)  # 1GB
...
class DiagnosticMixin:
    ...
    async def handle_diagnostic_request(self, request: MeshRequest, file: Optional[UploadFile] = None) -> Dict[str, Any]:
    ...
    def get_capabilities(self) -> list[MeshCapability]:
        ...
        business_capabilities = [
            MeshCapability(
                ...
                input_schema={"type": "object", "properties": {"target_format": {"type": "string"}}},

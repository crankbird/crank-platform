...
class DiagnosticMeshService(MeshInterface):
            ...
            MeshCapability(
                ...
                input_schema={
                    ...
                    "properties": {
                        ...
                        "expected_size": {"type": "integer", "description": "Expected file size in bytes"}
                    }
                },
                output_schema={
                    "type": "object",
    ...
    async def _handle_ping(self, request: MeshRequest, auth_context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_load_test(self, request: MeshRequest, auth_context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        memory_data = "x" * (memory_mb * 1024 * 1024) if memory_mb > 0 else ""
        ...
        return {
            ...
            "response_data": response_data[:100] + "..." if len(response_data) > 100 else response_data
        }
    
    async def _handle_error_test(self, request: MeshRequest, auth_context: Dict[str, Any]) -> Dict[str, Any]:

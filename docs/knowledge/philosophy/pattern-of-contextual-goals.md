id: zk20251023-502
title: "The Pattern of Contextual Goals"
...
attribution:
  ...
  provenance:
    sources: {human: 0.7, ai: 0.25, external: 0.05}
  notes: >
    Draws on systems thinking, teleology, and agile governance principles to describe a practical pattern for maintaining coherence without over-specification.
links:
  mentions: ["zk20251023-501"]

Concept:

A contextual goal is a directional attractor -- a guiding purpose that shapes how a system evolves without dictating how it is built.
...
In Crankbird's design language, contextual goals are the gravitational fields of innovation: they define what matters, not what must be done.

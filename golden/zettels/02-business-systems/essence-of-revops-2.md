...
attribution:
  ...
  provenance:
    sources: {human: 0.6, ai: 0.35, external: 0.05}
  notes: >
    Synthesised from discussion on the structure and purpose of modern RevOps organisations.
---

**Concept:**  
RevOps is the nervous system of the revenue engine.  
It aligns the signals of Marketing (attention), Sales (conversion), and Customer Success (retention) into a single model of *predictable growth.*  
The currency is not leads or deals — it’s *information integrity*.  
When the data flows, revenue follows.
